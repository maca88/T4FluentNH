...
//<EntityProjectItem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema"><EntityFullName>T4FluentNH.Tests.Inheritance.Owner</EntityFullName><EntityFilePaths><string>Inheritance\Owner.cs</string></EntityFilePaths><OverrideFilePaths /><GeneratedFilePath>Owner.generated.cs</GeneratedFilePath></EntityProjectItem>
namespace T4FluentNH.Tests.Inheritance
{
    ...
    public partial class Owner
    {
        ...
        public virtual Task AddDogAsync(Dog dog)
        {
            return this.AddOneToManyAsync(o => o.Dogs, dog, o => o.Owner, o=> o.RemoveDogAsync);
        }
        ...
        public virtual Task RemoveDogAsync(Dog dog)
        {
            return this.RemoveOneToManyAsync(o => o.Dogs, dog, o => o.Owner);
        }
        ...
        public virtual Task AddCatAsync(Cat cat)
        {
            return this.AddOneToManyAsync(o => o.Cats, cat, o => o.Owner, o=> o.RemoveCatAsync);
        }

        public virtual Task RemoveCatAsync(Cat cat)
        {
            return this.RemoveOneToManyAsync(o => o.Cats, cat, o => o.Owner);
        }
