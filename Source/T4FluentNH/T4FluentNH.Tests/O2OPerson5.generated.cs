...
namespace T4FluentNH.Tests.OneToOne
{
    ...
    public partial class O2OPerson5
    {
        ...
        public virtual Task SetIdentityCardAsync(O2OIdentityCard5 identityCard)
        {
