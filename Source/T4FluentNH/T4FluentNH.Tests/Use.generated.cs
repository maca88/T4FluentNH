...
namespace T4FluentNH.Tests.Naming
{
    ...
    public partial class Use
    {
        ...
        public virtual Task SetCaseAsync(Case @case)
        {
            return this.SetManyToOneAsync(o => o.Case, @case, o => o.RemoveUseAsync, o => o.Uses);
        }
        ...
        public virtual Task UnsetCaseAsync()
        {
            return this.UnsetManyToOneAsync(o => o.Case, o => o.Uses);
        }
